        ...
        <div class="col-md-10 col-sm-10">
            ...
            <div class="row" style="padding: 0px 5px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8 clearfix" style="position: absolute;margin: auto; left:0; right:0;">
                    <br>
                    <label>Timer:</label><br>
                    
                    <font class="countdown" id="countdown" color="red">59</font><span style="text-align: center; display: block;"">seconds left</span>
                    <label style="float:right;">
                        <div class"pull-right" style="float:left;">
                            <font color="red" size="22px">Score:</font>
                            <font id="score" class="score" color="#32CD32">0</font>
                        </div>
                    </label>
                    <br><br>
                    <div style="position:relative; margin: 10px 0 !important; text-align:center;">
                    ...
                    <?php
                        ...
                        foreach($answers as $answer) {
                            $i++;
                            ?>
                            <div class="col-md-8 clearfix" style="position:relative; margin: 10px 0 !important;">
...
<script>
    ...
    function answer(qui_id, an_id) {
        ...
        $.ajax({
          url: '<?php echo base_url() ?>admin/getResultAndNew',
          type: 'post',
          data: data,
        }).done(function (data) {
